...
@Component({
  selector: 'app-funcaoempresa',
  imports: [ListagemGenericaComponent],
  templateUrl: './funcaoempresa.component.html',
  styleUrls: ['./funcaoempresa.component.scss']
})
export class FuncaoempresaComponent implements OnInit {
  titulo: string = '';
  ...
  ngOnInit() {
    const configuracao = this.configService.getConfiguracao('funcaoempresa');
    if (configuracao) {
