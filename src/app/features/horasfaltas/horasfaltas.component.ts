...
@Component({
  selector: 'app-horasfaltas',
  imports: [ListagemGenericaComponent],
  templateUrl: './horasfaltas.component.html',
  styleUrls: ['./horasfaltas.component.scss']
})
export class HorasfaltasComponent implements OnInit {
  titulo: string = '';
  ...
  ngOnInit() {
    const configuracao = this.configService.getConfiguracao('horasfaltas');
    if (configuracao) {
