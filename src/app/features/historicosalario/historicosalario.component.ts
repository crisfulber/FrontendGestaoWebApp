...
@Component({
  selector: 'app-historicosalario',
  imports: [ListagemGenericaComponent],
  templateUrl: './historicosalario.component.html',
  styleUrls: ['./historicosalario.component.scss']
})
export class HistoricosalarioComponent implements OnInit {
  titulo: string = '';
  ...
  ngOnInit() {
    const configuracao = this.configService.getConfiguracao('historicosalario');
    if (configuracao) {
