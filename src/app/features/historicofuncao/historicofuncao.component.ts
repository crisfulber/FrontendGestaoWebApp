...
@Component({
  selector: 'app-historicofuncao',
  imports: [ListagemGenericaComponent],
  templateUrl: './historicofuncao.component.html',
  styleUrls: ['./historicofuncao.component.scss']
})
export class HistoricofuncaoComponent implements OnInit {
  ...
  ngOnInit() {
    const configuracao = this.configService.getConfiguracao('historicofuncao');
    if (configuracao) {
