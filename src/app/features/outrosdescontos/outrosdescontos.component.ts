...
@Component({
  selector: 'app-outrosdescontos',
  imports: [ListagemGenericaComponent],
  templateUrl: './outrosdescontos.component.html',
  styleUrls: ['./outrosdescontos.component.scss'],
})
export class OutrosdescontosComponent implements OnInit {
  titulo: string = '';
  ...
  ngOnInit() {
    const configuracao = this.configService.getConfiguracao('outrosdescontos');
    if (configuracao) {
