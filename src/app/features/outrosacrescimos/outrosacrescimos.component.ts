...
@Component({
  selector: 'app-outrosacrescimos',
  imports: [ListagemGenericaComponent],
  templateUrl: './outrosacrescimos.component.html',
  styleUrls: ['./outrosacrescimos.component.scss'],
})
export class OutrosacrescimosComponent implements OnInit {
  titulo: string = '';
  ...
  ngOnInit() {
    const configuracao = this.configService.getConfiguracao('outrosacrescimos');
    if (configuracao) {
